    ...
    def _batch_sampling_seq(self, batch_user_ids):
        ...
        for uid in batch_user_ids:
            ...
            for nxt_idx in self.ref_indices:
                one_sample = one_valid_sample(uid, self.data, self.seqlen,
                                              nxt_idx, self.n_items, user_tracks,
